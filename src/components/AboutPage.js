      ...
      <div className="about-page">
          ...
          <CustomScroll heightRelativeToParent="calc(100% - 20px)">
            <div className="page-content">
              ...
              <p>However, my current skillset includes JavaScript, React, Redux, Firebase, SASS, Boostrap, CSS, HTML etc. And thats excluding all the common (yet sometime complex) build/workflow tools like Webpack, Babel etc. And oh, No progressbar showing I'm 93% expert at React, Sorry.</p>
              <p>Simplicity, Though overused (and sometime misused) as a term, Its something I really value. I like to build build solutions that are simple yet interactive for the users.</p>
